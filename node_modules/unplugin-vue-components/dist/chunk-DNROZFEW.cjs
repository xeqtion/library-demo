...
var require_balanced_match = _chunk3HT76LNNcjs.__commonJS.call(void 0, {
...
var require_brace_expansion = _chunk3HT76LNNcjs.__commonJS.call(void 0, {
...
var import_brace_expansion = _chunk3HT76LNNcjs.__toESM.call(void 0, require_brace_expansion(), 1);
...
var AST = class _AST {
  ...
  toJSON() {
    ...
    if (this.isStart() && !this.type)
      ret.unshift([]);
    if (this.isEnd() && (this === this.#root || this.#root.#filledNegs && _optionalChain([this, 'access', _2 => _2.#parent, 'optionalAccess', _3 => _3.type]) === "!")) {
      ret.push({});
    }
    return ret;
  }
  isStart() {
    if (this.#root === this)
      return true;
    if (!_optionalChain([this, 'access', _4 => _4.#parent, 'optionalAccess', _5 => _5.isStart, 'call', _6 => _6()]))
      return false;
  ...
  isEnd() {
    if (this.#root === this)
      return true;
    if (_optionalChain([this, 'access', _7 => _7.#parent, 'optionalAccess', _8 => _8.type]) === "!")
      return true;
    if (!_optionalChain([this, 'access', _9 => _9.#parent, 'optionalAccess', _10 => _10.isEnd, 'call', _11 => _11()]))
      return false;
    if (!this.type)
      return _optionalChain([this, 'access', _12 => _12.#parent, 'optionalAccess', _13 => _13.isEnd, 'call', _14 => _14()]);
  ...
  toRegExpSource(allowDot) {
    const dot = _nullishCoalesce(allowDot, () => ( !!this.#options.dot));
    if (this.#root === this)
      this.#fillNegs();
    if (!this.type) {
      ...
      let end = "";
      if (this.isEnd() && this.#root.#filledNegs && _optionalChain([this, 'access', _15 => _15.#parent, 'optionalAccess', _16 => _16.type]) === "!") {
        end = "(?:$|\\/)";
      }
...
async function getPkgVersion(pkgName, defaultVersion) {
  try {
    ...
    if (isExist) {
      ...
      return _nullishCoalesce(_optionalChain([pkg, 'optionalAccess', _17 => _17.version]), () => ( defaultVersion));
    } else {
